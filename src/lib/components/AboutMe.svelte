<div class="h-screen w-full bg-cream-100 flex lg:flex-row flex-col gap-36 justify-center items-center">
    <div class="lg:w-[25rem] h-1/3">
        hoi
    </div>
    <div class="text-right w-auto lg:p-0 px-8">
        <p class="lg:text-3xl text-2xl font-light lg:text-right text-justify">
            ...
            I enjoy working in a team with <span class="highlight">hard-working</span><br class="lg:block hidden">people in
            agile way.<br class="lg:block hidden">My <span class="highlight">interests</span> root in videogames, volleyball,<br class="lg:block hidden">
